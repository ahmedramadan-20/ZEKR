...
class _DownloadDialogState extends State<DownloadDialog> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<QuranCubit>().downloadAllSurahs();
    });
  }

  @override
  void dispose() {
    // Clean up any pending BLoC subscriptions
    super.dispose();
  }
            ...
            state.maybeWhen(
              success:
                  (
                    ...
                    // Only close dialog when download is complete
                    // (not downloading in background anymore)
